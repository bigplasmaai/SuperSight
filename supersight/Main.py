...
if __name__ == "__main__" :
    ...
    ds.sections["Section 1"].add_page("Page 2")
    ds.sections["Section 1"].add_page("Page 3")
    ds.sections["Section 1"].add_page("Page 4")


    # In[7]:

    ds.sections["Section 1"].pages
    ...
    ds.sections["Section 2"].pages


    # In[11]:

    ds.sections["Section 2"].pages["Page 1"].layout
    ...
    for key in ds.sections:
        print(key)


    # In[14]:

    ds.sections["Section 2"].pages["Page 1"].add_element(name = "Graph", plot_object = None)


    # In[15]:

    ds.sections["Section 2"].pages["Page 1"].elements
    ...
    ds.sections["Section 1"].pages["Page 1"].layout = [(4, 4, 4), (6, 6), (4, 4, 4), (12,),]
    for el in range(9) :
        if el != 5:
            ds.sections["Section 1"].pages["Page 1"].add_element(name = "Graph {}".format(el), plot_object = buf2, heading = "HGraph {}".format(el))    
        else:
            ds.sections["Section 1"].pages["Page 1"].add_element(name = "Graph {}".format(el), plot_object = buf2, heading = None) 


    # In[18]:

    ds.sections["Home"].pages["Home"].layout = [(6, 6), (6, 6), (4, 4, 4), (12,), (3,3,3,3)]
    for el in range(12) :
        if el != 5:
            ds.sections["Home"].pages["Home"].add_element(name = "Graph {}".format(el), plot_object = buf, heading = "HGraph {}".format(el))    
        else:
            ds.sections["Home"].pages["Home"].add_element(name = "Graph {}".format(el), plot_object = buf, heading = None) 


    # In[19]:

    ds.sections["Home"].pages["Home"].elements.keys()


    # In[20]:

    ds.sections["Section 1"].pages["Page 1"].elements.keys()


    # In[21]:

    headings = []
    structure = [len(x) for x in ds.sections["Home"].pages["Home"].layout]
    for key in ds.sections["Home"].pages["Home"].elements.keys():
        headings.append(ds.sections["Home"].pages["Home"].elements[key].heading)
    ...
    ds.sections["Home"].pages["Home"].elements[key].heading
    ...
    ds.sections["Section 2"].pages["Page 1"].elements["Graph"].name
